...
(function () {
    ...
    function fillSearchInput() {
        var searchForms = document.querySelectorAll('#gridea-search-form');
        var queryPhrase = getQueryPhrase();
        searchForms.forEach(function(form) {
            var searchInput = form.querySelector('input[name="s"]') || form.querySelector('#s');
            if (searchInput) {
                searchInput.value = queryPhrase;
            }
        });
    }
