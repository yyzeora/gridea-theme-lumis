(function($){
	...
	$(document).ready(function($){
        ...
        $(document).on('click', '.mobile-menu-item, .mobile-menu-action a', function(){
            $('.mobile-menu-toggle').removeClass('active');
            $('.mobile-menu').removeClass('active');
        });
        ...
        // Back to top button (only for old back-to-top button, not social bar avatar)
        var bt;
        bt = $('#back-to-top:not(.social-avatar-wrapper)');
        if (bt.length && $(document).width() > 480) {
